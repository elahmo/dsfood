...
#sugar qty
n_sugar_comp <- runif(hg$sugar_comp)

#soft drinks
n_soft_drinks <- runif(hg$soft_drinks)

#all and sugar qty
n_all <- runif(hg$All_persons)
...
cor_75_over_soft <- cor(n_75_over, n_soft_drinks)sof
